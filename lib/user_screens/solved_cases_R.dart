...
class SolvedCasesPageR extends StatefulWidget {
  @override
  _SolvedCasesPageRState createState() => _SolvedCasesPageRState();
}

class _SolvedCasesPageRState extends State<SolvedCasesPageR> {
